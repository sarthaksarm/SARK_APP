...
public class GameMain extends AppCompatActivity {
    ...
    com.example.zugate.firecard.Play.TriviaQuizHelper triviaQuizHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        triviaQuizHelper = new com.example.zugate.firecard.Play.TriviaQuizHelper(this);
        //Make db writable
    ...
    public void gameLostPlayAgain() {
        Intent intent = new Intent(this, com.example.zugate.firecard.Play.PlayAgain.class);
        startActivity(intent);
        finish();
    }
    ...
    public void timeUp() {
        Intent intent = new Intent(this, com.example.zugate.firecard.Play.Time_Up.class);
        startActivity(intent);
        finish();
    }
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(com.example.zugate.firecard.Play.GameMain.this);
