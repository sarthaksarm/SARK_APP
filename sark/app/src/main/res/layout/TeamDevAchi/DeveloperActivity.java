...
public class DeveloperActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent intent=new Intent(com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.this,MainActivity.class);
                    startActivity(intent);
                    break;
                case R.id.navigation_dashboard:
                    Intent intent2=new Intent(com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.this,HomeScreen.class);
                    startActivity(intent2);
                    break;
                case R.id.navigation_notifications:
                    Intent intent3=new Intent(com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.this,Notification.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<com.example.zugate.firecard.TeamDevAchi.Blog, com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<com.example.zugate.firecard.TeamDevAchi.Blog, com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.BlogViewHolder>
                (com.example.zugate.firecard.TeamDevAchi.Blog.class, R.layout.cardview, com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.BlogViewHolder.class, mDatabase) {
            @Override
            protected void populateViewHolder(com.example.zugate.firecard.TeamDevAchi.DeveloperActivity.BlogViewHolder viewHolder, com.example.zugate.firecard.TeamDevAchi.Blog model, int position) {
