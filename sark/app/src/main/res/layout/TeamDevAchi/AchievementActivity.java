...
public class AchievementActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent intent=new Intent(com.example.zugate.firecard.TeamDevAchi.AchievementActivity.this,MainActivity.class);
                    startActivity(intent);
                    break;
                case R.id.navigation_dashboard:
                    Intent intent2=new Intent(com.example.zugate.firecard.TeamDevAchi.AchievementActivity.this,HomeScreen.class);
                    startActivity(intent2);
                    break;
                case R.id.navigation_notifications:
                    Intent intent3=new Intent(com.example.zugate.firecard.TeamDevAchi.AchievementActivity.this,Notification.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog, com.example.zugate.firecard.TeamDevAchi.AchievementActivity.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Blog, com.example.zugate.firecard.TeamDevAchi.AchievementActivity.BlogViewHolder>
                (Blog.class, R.layout.cardview, com.example.zugate.firecard.TeamDevAchi.AchievementActivity.BlogViewHolder.class, mDatabase) {
            @Override
